# Elder Scrolls Lore Reference — Races of Tamriel

> **Primary source:** UESP Lore:Races — https://en.uesp.net/wiki/Lore:Races  
> **Secondary:** Elder Scrolls Fandom Races — https://elderscrolls.fandom.com/wiki/Races  
> **Secondary:** In-game racial description texts across TES III, IV, V, and ESO

---

## Overview `[CANON — UESP]`

Tamriel's races are divided into three broad groups:
- **Mer** (Elves) — descended from the original **Aldmer** who arrived from Aldmeris in the Merethic Era
- **Men** (Humans) — descended from **Atmorans/Nedes** who migrated from Atmora
- **Beastfolk** — Argonians and Khajiit; distinct origins from both Mer and Men

All races are capable of interbreeding to varying degrees. Bretons are a notable example of long-term human-elf interbreeding (**Manmeri**). `[CANON — UESP]`

---

## Mer (Elves)

### Altmer (High Elves) `[CANON — UESP]`
> **Source:** UESP Lore:Altmer — https://en.uesp.net/wiki/Lore:Altmer

- **Homeland:** Summerset Isles (Alinor)
- **Physical traits:** Tallest of all playable races; golden or pale skin; amber eyes; extremely long-lived (centuries without magical aid)
- **Culture:** Hierarchical and elitist. Believe themselves the closest living descendants of the original Aldmer and therefore closest to the gods. Rigid social stratification; foreigners treated with suspicion or contempt.
- **Magic:** Naturally talented; among the most powerful mages in Tamriel.
- **Religion:** Worship a version of the Aedra with Auri-El (= Akatosh) as chief deity; also Magnus, Syrabane, Trinimac (now Malacath — they do not acknowledge this publicly `[CONTESTED]`).
- **Politics:** The **Aldmeri Dominion** is their Empire; the **Thalmor** is their secret-police/government body.

### Bosmer (Wood Elves) `[CANON — UESP]`
> **Source:** UESP Lore:Bosmer — https://en.uesp.net/wiki/Lore:Bosmer
...
### Orsimer (Orcs) `[CANON — UESP]`
> **Source:** UESP Lore:Orsimer — https://en.uesp.net/wiki/Lore:Orsimer

- **Homeland:** Orsinium (Wrothgarian Mountains, High Rock/Hammerfell border region); Orc strongholds scattered across Tamriel
- **Physical traits:** Greenish-grey skin; pronounced lower tusks; stocky and powerful
- **Origin:** Once the Aldmer followers of **Trinimac** (an Aedric warrior-god). When Boethiah ate/corrupted Trinimac, Trinimac became **Malacath** and his followers became the Orsimer — literally "the Pariah Folk" or "Cursed Elves". `[CANON — IN-GAME BOOK: The True Nature of Orcs]` ⚠️ Whether Malacath IS Trinimac or just an echo of him is `[CONTESTED — UESP]`
- **Culture:** **Code of Mauloch** — strict honour system governing clan life. Clan-based; Orc strongholds led by a chief. Renowned smiths (Orcish-grade armor). Endure prejudice across Tamriel.
- **Religion:** Worship **Malacath**; strongholds built around his teachings.
- **Orsinium destroyed multiple times:** 1E 416, c. 2E 430s, and at least once more. Always rebuilt. `[CANON — UESP]`

### Falmer (Snow Elves) `[CANON — UESP]`
> **Source:** UESP Lore:Falmer — https://en.uesp.net/wiki/Lore:Falmer

- **Homeland:** Originally Skyrim; now deep underground
- **History:** Ancient Snow Elves ruled Skyrim before the Atmorans arrived. After **Ysgramor's genocide** in the Merethic Era, surviving Snow Elves sought shelter with the **Dwemer**, who enslaved them and fed them **toxic fungi**, blinding and degenerating them over generations into the feral Falmer known in TES V.
...
### Nord `[CANON — UESP]`
> **Source:** UESP Lore:Nord — https://en.uesp.net/wiki/Lore:Nord
...
> **Source:** UESP Lore:Imperial — https://en.uesp.net/wiki/Lore:Imperial

- **Homeland:** Cyrodiil
- **Physical traits:** Medium build; adaptable; range of hair and skin tones
- **Culture:** Cosmopolitan and administratively skilled. Founded the Empire of Tamriel. Excel at trade, diplomacy, and governance. Naturally absorb other cultures and religions. The nine provinces were united under Imperial law at various points.
- **Religion:** The **Nine Divines** (Alessian pantheon) — Akatosh, Arkay, Dibella, Julianos, Kynareth, Mara, Stendarr, Zenithar, and Talos. See `04_divines.md`.

### Redguard `[CANON — UESP]`
> **Source:** UESP Lore:Redguard — https://en.uesp.net/wiki/Lore:Redguard

- **Homeland:** Hammerfell (originally from **Yokuda**)
- **Physical traits:** Dark skin; wiry and athletic; high natural resistance to poison and disease
- **Culture:** Warrior culture centred on individual honour and martial excellence. **Ansei** (Sword-Saints) could manifest a **Shehai** (spirit sword) through pure will. `[CANON — IN-GAME BOOK: The Reachmen; TES Redguard game]` Two factions: **Crowns** (traditional) and **Forebears** (Imperial-aligned). `[CANON — UESP]`
- **Religion:** Yokudan pantheon; **HoonDing** (Make Way god), **Tava** (bird goddess = Kynareth), **Morwha** (fertility), **Leki** (saint of the Ansei). `[CANON — UESP]`

### Breton `[CANON — UESP]`
> **Source:** UESP Lore:Breton — https://en.uesp.net/wiki/Lore:Breton
...
### Argonian `[CANON — UESP]`
> **Source:** UESP Lore:Argonian — https://en.uesp.net/wiki/Lore:Argonian

- **Homeland:** Black Marsh (Argonia)
- **Physical traits:** Reptilian; amphibious; disease-resistant; can breathe underwater; scale colour and crest pattern vary widely
...
## Extinct, Rare, and Lore-Only Races

These races appear in lore but are not available as playable races in most games.

| Race | Region | Status | Notes |
|---|---|---|---|
...
| **Keptu** | High Rock | Extinct `[CANON]` | Proto-human inhabitants of High Rock; distinct from Redguards. `[CANON — UESP]` ⚠️ NOT Redguard ancestors; a separate ethnicity. |
| **Maormer (Sea Elves)** | Pyandonea | Extant (off-continent) `[CANON]` | Tropical Elves exiled from Summerset; constantly raid the Summerset coasts. Chameleon-like appearance. `[CANON — UESP]` |
| **Tang Mo** | Akavir | Extant (off-continent) `[CANON]` | Monkey-folk of Akavir; frequently enslaved by the Tsaesci but resist fiercely. `[CANON — IN-GAME BOOK: Mysterious Akavir]` |
